...
```{r altmetrics, warning=FALSE, message=FALSE}
library(rAltmetric)
library(alm)
library(rentrez)
library(rplos)
...
```{r omics_tweets, warning=FALSE, message=FALSE}
...
```{r plos_alm , warning=FALSE, message=FALSE}
...
```{r cite_hist, warning=FALSE, message=FALSE }
